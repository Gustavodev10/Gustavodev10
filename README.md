...
Graduando em **Ciência da Computação** no Centro Universitário Governador Ozanam Coelho e apaixonado por engenharia de software e arquitetura de sistemas. Atualmente, atuo como **Estagiário de TI na Cooperativa Montenegro**, com foco em desenvolvimento Back-end Java, Spring Boot, otimização de banco de dados SQL Server e sustentação de sistemas.
...
![IA Aplicada](https://img.shields.io/badge/IA%20Aplicada-673AB7?style=for-the-badge&logo=openai&logoColor=white)
![Engenharia de Prompt](https://img.shields.io/badge/Engenharia_de_Prompt-7E57C2?style=for-the-badge&logo=openai&logoColor=white)
